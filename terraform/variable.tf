...
variable "cluster_name" {
  ...
  type        = string
  default     = "zero-downtime-cluster" # You can modify the cluster name as needed
}
...
variable "s3_bucket_name" {
  ...
  type        = string
  default     = "new1-2134-90-freelancing" # Replace with your actual S3 bucket name make sure the bucket exists
}